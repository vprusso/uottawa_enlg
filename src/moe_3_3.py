"""Monogamy-of-entanglement game with 3 inputs and 3 outputs with quantum advantage."""
import numpy as np
...
def moe_mub_3_in_3_out_game():
    """Define the monogamy-of-entanglement game defined by MUBs."""
    dim = 3
    prob_mat = 1 / dim * np.identity(dim)
...
if __name__ == "__main__":
    prob_mat, pred_mat = moe_mub_3_in_3_out_game()
